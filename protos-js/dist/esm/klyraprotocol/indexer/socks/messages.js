//@ts-nocheck
import { IndexerSubaccountId } from "../protocol/v1/subaccount";
...
export const OrderbookMessage = {
    ...
    is(o) {
        return o && (o.$typeUrl === OrderbookMessage.typeUrl || typeof o.contents === "string" && typeof o.clobPairId === "string" && typeof o.version === "string");
    },
    isSDK(o) {
        return o && (o.$typeUrl === OrderbookMessage.typeUrl || typeof o.contents === "string" && typeof o.clob_pair_id === "string" && typeof o.version === "string");
    },
    isAmino(o) {
        return o && (o.$typeUrl === OrderbookMessage.typeUrl || typeof o.contents === "string" && typeof o.clob_pair_id === "string" && typeof o.version === "string");
    },
...
GlobalDecoderRegistry.register(OrderbookMessage.typeUrl, OrderbookMessage);
...
export const SubaccountMessage = {
    ...
    is(o) {
        return o && (o.$typeUrl === SubaccountMessage.typeUrl || typeof o.blockHeight === "string" && typeof o.transactionIndex === "number" && typeof o.eventIndex === "number" && typeof o.contents === "string" && typeof o.version === "string");
    },
    isSDK(o) {
        return o && (o.$typeUrl === SubaccountMessage.typeUrl || typeof o.block_height === "string" && typeof o.transaction_index === "number" && typeof o.event_index === "number" && typeof o.contents === "string" && typeof o.version === "string");
    },
    isAmino(o) {
        return o && (o.$typeUrl === SubaccountMessage.typeUrl || typeof o.block_height === "string" && typeof o.transaction_index === "number" && typeof o.event_index === "number" && typeof o.contents === "string" && typeof o.version === "string");
    },
...
GlobalDecoderRegistry.register(SubaccountMessage.typeUrl, SubaccountMessage);
...
export const TradeMessage = {
    ...
    is(o) {
        return o && (o.$typeUrl === TradeMessage.typeUrl || typeof o.blockHeight === "string" && typeof o.contents === "string" && typeof o.clobPairId === "string" && typeof o.version === "string");
    },
    isSDK(o) {
        return o && (o.$typeUrl === TradeMessage.typeUrl || typeof o.block_height === "string" && typeof o.contents === "string" && typeof o.clob_pair_id === "string" && typeof o.version === "string");
    },
    isAmino(o) {
        return o && (o.$typeUrl === TradeMessage.typeUrl || typeof o.block_height === "string" && typeof o.contents === "string" && typeof o.clob_pair_id === "string" && typeof o.version === "string");
    },
...
GlobalDecoderRegistry.register(TradeMessage.typeUrl, TradeMessage);
...
export const MarketMessage = {
    ...
    is(o) {
        return o && (o.$typeUrl === MarketMessage.typeUrl || typeof o.contents === "string" && typeof o.version === "string");
    },
    isSDK(o) {
        return o && (o.$typeUrl === MarketMessage.typeUrl || typeof o.contents === "string" && typeof o.version === "string");
    },
...
GlobalDecoderRegistry.register(MarketMessage.typeUrl, MarketMessage);
...
export const CandleMessage = {
    ...
    is(o) {
        return o && (o.$typeUrl === CandleMessage.typeUrl || typeof o.contents === "string" && typeof o.clobPairId === "string" && isSet(o.resolution) && typeof o.version === "string");
    },
    isSDK(o) {
        return o && (o.$typeUrl === CandleMessage.typeUrl || typeof o.contents === "string" && typeof o.clob_pair_id === "string" && isSet(o.resolution) && typeof o.version === "string");
    },
    isAmino(o) {
        return o && (o.$typeUrl === CandleMessage.typeUrl || typeof o.contents === "string" && typeof o.clob_pair_id === "string" && isSet(o.resolution) && typeof o.version === "string");
    },
...
GlobalDecoderRegistry.register(CandleMessage.typeUrl, CandleMessage);
