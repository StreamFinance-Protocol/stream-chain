...
type SubaccountUpdateEventV1 struct {
	...
	YieldsIndex           string                        `protobuf:"bytes,5,opt,name=yields_index,json=yieldsIndex,proto3" json:"yields_index,omitempty"`
}
...
func (m *SubaccountUpdateEventV1) GetYieldsIndex() string {
	if m != nil {
		return m.YieldsIndex
	}
	return ""
}
...
type CollateralPoolUpsertEvent struct {
	...
	MultiCollateralAssets []uint32 `protobuf:"varint,3,rep,packed,name=multi_collateral_assets,json=multiCollateralAssets,proto3" json:"multi_collateral_assets,omitempty"`
...
func (m *CollateralPoolUpsertEvent) Reset()         { *m = CollateralPoolUpsertEvent{} }
func (m *CollateralPoolUpsertEvent) String() string { return proto.CompactTextString(m) }
func (*CollateralPoolUpsertEvent) ProtoMessage()    {}
func (*CollateralPoolUpsertEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_3fab40ae4da50191, []int{16}
}
func (m *CollateralPoolUpsertEvent) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CollateralPoolUpsertEvent) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CollateralPoolUpsertEvent.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CollateralPoolUpsertEvent) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CollateralPoolUpsertEvent.Merge(m, src)
}
func (m *CollateralPoolUpsertEvent) XXX_Size() int {
	return m.Size()
}
func (m *CollateralPoolUpsertEvent) XXX_DiscardUnknown() {
	xxx_messageInfo_CollateralPoolUpsertEvent.DiscardUnknown(m)
}

var xxx_messageInfo_CollateralPoolUpsertEvent proto.InternalMessageInfo

func (m *CollateralPoolUpsertEvent) GetId() uint32 {
	if m != nil {
		return m.Id
	}
	return 0
...
func (m *CollateralPoolUpsertEvent) GetMaxCumulativeInsuranceFundDeltaPerBlock() uint64 {
	if m != nil {
...
func (m *CollateralPoolUpsertEvent) GetMultiCollateralAssets() []uint32 {
	if m != nil {
...
func (m *CollateralPoolUpsertEvent) GetQuoteAssetId() uint32 {
	if m != nil {
...
type PerpetualMarketCreateEventV2 struct {
	...
	CollateralPoolId uint32 `protobuf:"varint,12,opt,name=collateral_pool_id,json=collateralPoolId,proto3" json:"collateral_pool_id,omitempty"`
}
...
func (m *PerpetualMarketCreateEventV2) GetCollateralPoolId() uint32 {
	if m != nil {
...
type UpdatePerpetualEventV1 struct {
	...
	PerpYieldsIndex string `protobuf:"bytes,7,opt,name=perp_yields_index,json=perpYieldsIndex,proto3" json:"perp_yields_index,omitempty"`
}
...
func (m *UpdatePerpetualEventV1) GetPerpYieldsIndex() string {
	if m != nil {
		return m.PerpYieldsIndex
	}
	return ""
}
...
type UpdateYieldsParamsEventV1 struct {
	...
	AssetYieldsIndex string `protobuf:"bytes,2,opt,name=asset_yields_index,json=assetYieldsIndex,proto3" json:"asset_yields_index,omitempty"`
}

func (m *UpdateYieldsParamsEventV1) Reset()         { *m = UpdateYieldsParamsEventV1{} }
func (m *UpdateYieldsParamsEventV1) String() string { return proto.CompactTextString(m) }
func (*UpdateYieldsParamsEventV1) ProtoMessage()    {}
func (*UpdateYieldsParamsEventV1) Descriptor() ([]byte, []int) {
	return fileDescriptor_3fab40ae4da50191, []int{24}
}
func (m *UpdateYieldsParamsEventV1) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *UpdateYieldsParamsEventV1) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_UpdateYieldsParamsEventV1.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *UpdateYieldsParamsEventV1) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateYieldsParamsEventV1.Merge(m, src)
}
func (m *UpdateYieldsParamsEventV1) XXX_Size() int {
	return m.Size()
}
func (m *UpdateYieldsParamsEventV1) XXX_DiscardUnknown() {
	xxx_messageInfo_UpdateYieldsParamsEventV1.DiscardUnknown(m)
}

var xxx_messageInfo_UpdateYieldsParamsEventV1 proto.InternalMessageInfo

func (m *UpdateYieldsParamsEventV1) GetSdaiPrice() string {
	if m != nil {
		return m.SdaiPrice
	}
	return ""
...
func (m *UpdateYieldsParamsEventV1) GetAssetYieldsIndex() string {
	if m != nil {
		return m.AssetYieldsIndex
	}
	return ""
}
...
func init() {
	...
	proto.RegisterType((*CollateralPoolUpsertEvent)(nil), "klyraprotocol.indexer.events.CollateralPoolUpsertEvent")
	...
	proto.RegisterType((*UpdateYieldsParamsEventV1)(nil), "klyraprotocol.indexer.events.UpdateYieldsParamsEventV1")
}
...
var fileDescriptor_3fab40ae4da50191 = []byte{
	...
	,
}
...
func (m *SubaccountUpdateEventV1) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.YieldsIndex) > 0 {
		i -= len(m.YieldsIndex)
		copy(dAtA[i:], m.YieldsIndex)
		i = encodeVarintEvents(dAtA, i, uint64(len(m.YieldsIndex)))
		i--
		dAtA[i] = 0x2a
	}
...
func (m *CollateralPoolUpsertEvent) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CollateralPoolUpsertEvent) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CollateralPoolUpsertEvent) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.QuoteAssetId != 0 {
		i = encodeVarintEvents(dAtA, i, uint64(m.QuoteAssetId))
		i--
		dAtA[i] = 0x20
	}
	if len(m.MultiCollateralAssets) > 0 {
		dAtA29 := make([]byte, len(m.MultiCollateralAssets)*10)
		var j28 int
		...
		i = encodeVarintEvents(dAtA, i, uint64(j28))
		i--
		dAtA[i] = 0x1a
	}
	if m.MaxCumulativeInsuranceFundDeltaPerBlock != 0 {
		i = encodeVarintEvents(dAtA, i, uint64(m.MaxCumulativeInsuranceFundDeltaPerBlock))
		i--
		dAtA[i] = 0x10
	}
	if m.Id != 0 {
...
func (m *PerpetualMarketCreateEventV2) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.CollateralPoolId != 0 {
		i = encodeVarintEvents(dAtA, i, uint64(m.CollateralPoolId))
		i--
		dAtA[i] = 0x60
	}
...
func (m *UpdatePerpetualEventV1) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.PerpYieldsIndex) > 0 {
		i -= len(m.PerpYieldsIndex)
		copy(dAtA[i:], m.PerpYieldsIndex)
		i = encodeVarintEvents(dAtA, i, uint64(len(m.PerpYieldsIndex)))
		i--
		dAtA[i] = 0x3a
	}
	if m.DangerIndexPpm != 0 {
...
func (m *UpdateYieldsParamsEventV1) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *UpdateYieldsParamsEventV1) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UpdateYieldsParamsEventV1) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.AssetYieldsIndex) > 0 {
		i -= len(m.AssetYieldsIndex)
		copy(dAtA[i:], m.AssetYieldsIndex)
		i = encodeVarintEvents(dAtA, i, uint64(len(m.AssetYieldsIndex)))
		i--
		dAtA[i] = 0x12
	}
...
func (m *CollateralPoolUpsertEvent) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.MaxCumulativeInsuranceFundDeltaPerBlock != 0 {
		n += 1 + sovEvents(uint64(m.MaxCumulativeInsuranceFundDeltaPerBlock))
	}
	if len(m.MultiCollateralAssets) > 0 {
		l = 0
	...
	if m.QuoteAssetId != 0 {
		n += 1 + sovEvents(uint64(m.QuoteAssetId))
	}
	return n
}
...
func (m *PerpetualMarketCreateEventV2) Size() (n int) {
	...
	if m.CollateralPoolId != 0 {
		n += 1 + sovEvents(uint64(m.CollateralPoolId))
	}
	return n
}
...
func (m *UpdateYieldsParamsEventV1) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SubaccountUpdateEventV1) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field YieldsIndex", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.YieldsIndex = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipEvents(dAtA[iNdEx:])
...
func (m *CollateralPoolUpsertEvent) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CollateralPoolUpsertEvent: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CollateralPoolUpsertEvent: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *UpdatePerpetualEventV1) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PerpYieldsIndex", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PerpYieldsIndex = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipEvents(dAtA[iNdEx:])
...
func (m *UpdateYieldsParamsEventV1) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UpdateYieldsParamsEventV1: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UpdateYieldsParamsEventV1: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AssetYieldsIndex", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AssetYieldsIndex = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipEvents(dAtA[iNdEx:])
