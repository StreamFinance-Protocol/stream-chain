...
exports.CommitInfo = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.CommitInfo.typeUrl || typeof o.version === "bigint" && Array.isArray(o.storeInfos) && (!o.storeInfos.length || exports.StoreInfo.is(o.storeInfos[0])) && timestamp_1.Timestamp.is(o.timestamp));
    },
    isSDK(o) {
