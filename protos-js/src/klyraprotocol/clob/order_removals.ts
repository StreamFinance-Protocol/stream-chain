...
export interface OrderRemovalAminoMsg {
  type: "/klyraprotocol.clob.OrderRemoval";
...
export const OrderRemoval = {
  typeUrl: "/klyraprotocol.clob.OrderRemoval",
  is(o: any): o is OrderRemoval {
    return o && (o.$typeUrl === OrderRemoval.typeUrl || OrderId.is(o.orderId) && isSet(o.removalReason));
  },
  isSDK(o: any): o is OrderRemovalSDKType {
    return o && (o.$typeUrl === OrderRemoval.typeUrl || OrderId.isSDK(o.order_id) && isSet(o.removal_reason));
  },
  isAmino(o: any): o is OrderRemovalAmino {
    return o && (o.$typeUrl === OrderRemoval.typeUrl || OrderId.isAmino(o.order_id) && isSet(o.removal_reason));
  },
...
GlobalDecoderRegistry.register(OrderRemoval.typeUrl, OrderRemoval);