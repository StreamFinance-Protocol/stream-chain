...
exports.PendingSendPacket = {
    ...
    is(o) {
        return o && (o.$typeUrl === exports.PendingSendPacket.typeUrl || typeof o.channelId === "string" && typeof o.sequence === "bigint");
    },
    isSDK(o) {
        return o && (o.$typeUrl === exports.PendingSendPacket.typeUrl || typeof o.channel_id === "string" && typeof o.sequence === "bigint");
    },
    isAmino(o) {
        return o && (o.$typeUrl === exports.PendingSendPacket.typeUrl || typeof o.channel_id === "string" && typeof o.sequence === "bigint");
    },
...
registry_1.GlobalDecoderRegistry.register(exports.PendingSendPacket.typeUrl, exports.PendingSendPacket);
