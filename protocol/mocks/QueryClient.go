...
func (_m *QueryClient) GetAssetYieldIndexQuery(ctx context.Context, in *yieldtypes.GetAssetYieldIndexQueryRequest, opts ...grpc.CallOption) (*yieldtypes.GetAssetYieldIndexQueryResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *yieldtypes.GetAssetYieldIndexQueryResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *yieldtypes.GetAssetYieldIndexQueryRequest, ...grpc.CallOption) (*yieldtypes.GetAssetYieldIndexQueryResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *yieldtypes.GetAssetYieldIndexQueryRequest, ...grpc.CallOption) *yieldtypes.GetAssetYieldIndexQueryResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*yieldtypes.GetAssetYieldIndexQueryResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *yieldtypes.GetAssetYieldIndexQueryRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *QueryClient) GetSDAIPriceQuery(ctx context.Context, in *yieldtypes.GetSDAIPriceQueryRequest, opts ...grpc.CallOption) (*yieldtypes.GetSDAIPriceQueryResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *yieldtypes.GetSDAIPriceQueryResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *yieldtypes.GetSDAIPriceQueryRequest, ...grpc.CallOption) (*yieldtypes.GetSDAIPriceQueryResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *yieldtypes.GetSDAIPriceQueryRequest, ...grpc.CallOption) *yieldtypes.GetSDAIPriceQueryResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*yieldtypes.GetSDAIPriceQueryResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *yieldtypes.GetSDAIPriceQueryRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
