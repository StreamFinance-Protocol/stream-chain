...
export const MEVMatch = {
  ...
  is(o: any): o is MEVMatch {
    return o && (o.$typeUrl === MEVMatch.typeUrl || typeof o.takerFeePpm === "number" && typeof o.makerOrderSubticks === "bigint" && typeof o.makerOrderIsBuy === "boolean" && typeof o.makerFeePpm === "number" && typeof o.clobPairId === "number" && typeof o.fillAmount === "bigint");
  },
  isSDK(o: any): o is MEVMatchSDKType {
    return o && (o.$typeUrl === MEVMatch.typeUrl || typeof o.taker_fee_ppm === "number" && typeof o.maker_order_subticks === "bigint" && typeof o.maker_order_is_buy === "boolean" && typeof o.maker_fee_ppm === "number" && typeof o.clob_pair_id === "number" && typeof o.fill_amount === "bigint");
  },
...
GlobalDecoderRegistry.register(MEVMatch.typeUrl, MEVMatch);
...
export const MEVLiquidationMatch = {
  ...
  is(o: any): o is MEVLiquidationMatch {
    return o && (o.$typeUrl === MEVLiquidationMatch.typeUrl || SubaccountId.is(o.liquidatedSubaccountId) && typeof o.insuranceFundDeltaQuoteQuantums === "bigint" && typeof o.validatorFeeQuoteQuantums === "bigint" && typeof o.liquidityFeeQuoteQuantums === "bigint" && SubaccountId.is(o.makerOrderSubaccountId) && typeof o.makerOrderSubticks === "bigint" && typeof o.makerOrderIsBuy === "boolean" && typeof o.makerFeePpm === "number" && typeof o.clobPairId === "number" && typeof o.fillAmount === "bigint");
  },
  isSDK(o: any): o is MEVLiquidationMatchSDKType {
    return o && (o.$typeUrl === MEVLiquidationMatch.typeUrl || SubaccountId.isSDK(o.liquidated_subaccount_id) && typeof o.insurance_fund_delta_quote_quantums === "bigint" && typeof o.validator_fee_quote_quantums === "bigint" && typeof o.liquidity_fee_quote_quantums === "bigint" && SubaccountId.isSDK(o.maker_order_subaccount_id) && typeof o.maker_order_subticks === "bigint" && typeof o.maker_order_is_buy === "boolean" && typeof o.maker_fee_ppm === "number" && typeof o.clob_pair_id === "number" && typeof o.fill_amount === "bigint");
  },
  isAmino(o: any): o is MEVLiquidationMatchAmino {
    return o && (o.$typeUrl === MEVLiquidationMatch.typeUrl || SubaccountId.isAmino(o.liquidated_subaccount_id) && typeof o.insurance_fund_delta_quote_quantums === "bigint" && typeof o.validator_fee_quote_quantums === "bigint" && typeof o.liquidity_fee_quote_quantums === "bigint" && SubaccountId.isAmino(o.maker_order_subaccount_id) && typeof o.maker_order_subticks === "bigint" && typeof o.maker_order_is_buy === "boolean" && typeof o.maker_fee_ppm === "number" && typeof o.clob_pair_id === "number" && typeof o.fill_amount === "bigint");
  },
...
GlobalDecoderRegistry.register(MEVLiquidationMatch.typeUrl, MEVLiquidationMatch);
...
export const ClobMidPrice = {
  ...
  is(o: any): o is ClobMidPrice {
    return o && (o.$typeUrl === ClobMidPrice.typeUrl || ClobPair.is(o.clobPair) && typeof o.subticks === "bigint");
  },
  isSDK(o: any): o is ClobMidPriceSDKType {
    return o && (o.$typeUrl === ClobMidPrice.typeUrl || ClobPair.isSDK(o.clob_pair) && typeof o.subticks === "bigint");
  },
  isAmino(o: any): o is ClobMidPriceAmino {
    return o && (o.$typeUrl === ClobMidPrice.typeUrl || ClobPair.isAmino(o.clob_pair) && typeof o.subticks === "bigint");
  },
...
GlobalDecoderRegistry.register(ClobMidPrice.typeUrl, ClobMidPrice);
...
export const ValidatorMevMatches = {
  ...
  is(o: any): o is ValidatorMevMatches {
    return o && (o.$typeUrl === ValidatorMevMatches.typeUrl || Array.isArray(o.matches) && (!o.matches.length || MEVMatch.is(o.matches[0])) && Array.isArray(o.liquidationMatches) && (!o.liquidationMatches.length || MEVLiquidationMatch.is(o.liquidationMatches[0])));
  },
  isSDK(o: any): o is ValidatorMevMatchesSDKType {
    return o && (o.$typeUrl === ValidatorMevMatches.typeUrl || Array.isArray(o.matches) && (!o.matches.length || MEVMatch.isSDK(o.matches[0])) && Array.isArray(o.liquidation_matches) && (!o.liquidation_matches.length || MEVLiquidationMatch.isSDK(o.liquidation_matches[0])));
  },
  isAmino(o: any): o is ValidatorMevMatchesAmino {
    return o && (o.$typeUrl === ValidatorMevMatches.typeUrl || Array.isArray(o.matches) && (!o.matches.length || MEVMatch.isAmino(o.matches[0])) && Array.isArray(o.liquidation_matches) && (!o.liquidation_matches.length || MEVLiquidationMatch.isAmino(o.liquidation_matches[0])));
  },
...
GlobalDecoderRegistry.register(ValidatorMevMatches.typeUrl, ValidatorMevMatches);
...
export const MevNodeToNodeMetrics = {
  ...
  is(o: any): o is MevNodeToNodeMetrics {
    return o && (o.$typeUrl === MevNodeToNodeMetrics.typeUrl || Array.isArray(o.clobMidPrices) && (!o.clobMidPrices.length || ClobMidPrice.is(o.clobMidPrices[0])) && typeof o.proposalReceiveTime === "bigint");
  },
  isSDK(o: any): o is MevNodeToNodeMetricsSDKType {
    return o && (o.$typeUrl === MevNodeToNodeMetrics.typeUrl || Array.isArray(o.clob_mid_prices) && (!o.clob_mid_prices.length || ClobMidPrice.isSDK(o.clob_mid_prices[0])) && typeof o.proposal_receive_time === "bigint");
  },
  isAmino(o: any): o is MevNodeToNodeMetricsAmino {
    return o && (o.$typeUrl === MevNodeToNodeMetrics.typeUrl || Array.isArray(o.clob_mid_prices) && (!o.clob_mid_prices.length || ClobMidPrice.isAmino(o.clob_mid_prices[0])) && typeof o.proposal_receive_time === "bigint");
  },
...
GlobalDecoderRegistry.register(MevNodeToNodeMetrics.typeUrl, MevNodeToNodeMetrics);