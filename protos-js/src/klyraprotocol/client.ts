...
export const getSigningKlyraprotocolClient = async ({
  rpcEndpoint,
  signer,
  defaultTypes = defaultRegistryTypes
}: {
  ...
  const {
    registry,
    aminoTypes
  } = getSigningKlyraprotocolClientOptions({
    defaultTypes
  });
