...
export const UpdateMarketPricesRequest = {
  ...
  is(o: any): o is UpdateMarketPricesRequest {
    return o && (o.$typeUrl === UpdateMarketPricesRequest.typeUrl || Array.isArray(o.marketPriceUpdates) && (!o.marketPriceUpdates.length || MarketPriceUpdate.is(o.marketPriceUpdates[0])));
  },
  isSDK(o: any): o is UpdateMarketPricesRequestSDKType {
    return o && (o.$typeUrl === UpdateMarketPricesRequest.typeUrl || Array.isArray(o.market_price_updates) && (!o.market_price_updates.length || MarketPriceUpdate.isSDK(o.market_price_updates[0])));
  },
  isAmino(o: any): o is UpdateMarketPricesRequestAmino {
    return o && (o.$typeUrl === UpdateMarketPricesRequest.typeUrl || Array.isArray(o.market_price_updates) && (!o.market_price_updates.length || MarketPriceUpdate.isAmino(o.market_price_updates[0])));
  },
...
GlobalDecoderRegistry.register(UpdateMarketPricesRequest.typeUrl, UpdateMarketPricesRequest);
...
export const UpdateMarketPricesResponse = {
  ...
  is(o: any): o is UpdateMarketPricesResponse {
    return o && o.$typeUrl === UpdateMarketPricesResponse.typeUrl;
  },
...
GlobalDecoderRegistry.register(UpdateMarketPricesResponse.typeUrl, UpdateMarketPricesResponse);
...
export const ExchangePrice = {
  ...
  is(o: any): o is ExchangePrice {
    return o && (o.$typeUrl === ExchangePrice.typeUrl || typeof o.exchangeId === "string" && typeof o.price === "bigint");
  },
  isSDK(o: any): o is ExchangePriceSDKType {
    return o && (o.$typeUrl === ExchangePrice.typeUrl || typeof o.exchange_id === "string" && typeof o.price === "bigint");
  },
...
GlobalDecoderRegistry.register(ExchangePrice.typeUrl, ExchangePrice);
...
export const MarketPriceUpdate = {
  ...
  is(o: any): o is MarketPriceUpdate {
    return o && (o.$typeUrl === MarketPriceUpdate.typeUrl || typeof o.marketId === "number" && Array.isArray(o.exchangePrices) && (!o.exchangePrices.length || ExchangePrice.is(o.exchangePrices[0])));
  },
  isSDK(o: any): o is MarketPriceUpdateSDKType {
    return o && (o.$typeUrl === MarketPriceUpdate.typeUrl || typeof o.market_id === "number" && Array.isArray(o.exchange_prices) && (!o.exchange_prices.length || ExchangePrice.isSDK(o.exchange_prices[0])));
  },
  isAmino(o: any): o is MarketPriceUpdateAmino {
    return o && (o.$typeUrl === MarketPriceUpdate.typeUrl || typeof o.market_id === "number" && Array.isArray(o.exchange_prices) && (!o.exchange_prices.length || ExchangePrice.isAmino(o.exchange_prices[0])));
  },
