...
// GetAssetYieldsIndexQuery provides a mock function with given fields: ctx, in, opts
func (_m *QueryClient) GetAssetYieldsIndexQuery(ctx context.Context, in *yieldstypes.GetAssetYieldsIndexQueryRequest, opts ...grpc.CallOption) (*yieldstypes.GetAssetYieldsIndexQueryResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for GetAssetYieldsIndexQuery")
	}

	var r0 *yieldstypes.GetAssetYieldsIndexQueryResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *yieldstypes.GetAssetYieldsIndexQueryRequest, ...grpc.CallOption) (*yieldstypes.GetAssetYieldsIndexQueryResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *yieldstypes.GetAssetYieldsIndexQueryRequest, ...grpc.CallOption) *yieldstypes.GetAssetYieldsIndexQueryResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*yieldstypes.GetAssetYieldsIndexQueryResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *yieldstypes.GetAssetYieldsIndexQueryRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *QueryClient) GetSDAIPriceQuery(ctx context.Context, in *yieldstypes.GetSDAIPriceQueryRequest, opts ...grpc.CallOption) (*yieldstypes.GetSDAIPriceQueryResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *yieldstypes.GetSDAIPriceQueryResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *yieldstypes.GetSDAIPriceQueryRequest, ...grpc.CallOption) (*yieldstypes.GetSDAIPriceQueryResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *yieldstypes.GetSDAIPriceQueryRequest, ...grpc.CallOption) *yieldstypes.GetSDAIPriceQueryResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*yieldstypes.GetSDAIPriceQueryResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *yieldstypes.GetSDAIPriceQueryRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
