...
func TestBTCCollatBatchCancelSingleCancelFunctionality(t *testing.T) {
	tests := map[string]struct {
		firstBlockOrders       []clobtypes.MsgPlaceOrder
		firstBlockBatchCancel  []clobtypes.MsgBatchCancel
		secondBlockOrders      []clobtypes.MsgPlaceOrder
		...
		"Cancel unfilled short term order": {
			...
			firstBlockBatchCancel: []clobtypes.MsgBatchCancel{
				{
					SubaccountId: PlaceOrder_Alice_Num11_Id0_Clob2_Buy5_Price10_GTB5.Order.OrderId.SubaccountId,
					ShortTermCancels: []clobtypes.OrderBatch{
						{
							ClobPairId: 2,
							ClientIds:  []uint32{0},
		...
		"Cancel unfilled BTC short term order": {
			firstBlockOrders: []clobtypes.MsgPlaceOrder{
				PlaceOrder_Alice_Num11_Id0_Clob2_Buy5_Price10_GTB5,
			},
			firstBlockBatchCancel: []clobtypes.MsgBatchCancel{
...
var (
	...
	PlaceOrder_Alice_Num11_Id0_Clob2_Sell10_Price10_GTB20 = *clobtypes.NewMsgPlaceOrder(
		testapp.MustScaleOrder(
			constants.Order_Alice_Num11_Id0_Clob2_Sell10_Price10_GTB20,
			testapp.DefaultGenesis(),
		),
	)
	...
	PlaceOrder_Alice_Num11_Id0_Clob2_Sell10_Price10_GTB30 = *clobtypes.NewMsgPlaceOrder(
		testapp.MustScaleOrder(
			constants.Order_Alice_Num11_Id0_Clob2_Sell10_Price10_GTB30,
			testapp.DefaultGenesis(),
		),
	)
	...
	PlaceOrder_Alice_Num11_Id1_Clob2_Sell10_Price15_GTB20 = *clobtypes.NewMsgPlaceOrder(
		testapp.MustScaleOrder(
			constants.Order_Alice_Num11_Id1_Clob2_Sell10_Price15_GTB20,
			testapp.DefaultGenesis(),
		),
	)
	...
	PlaceOrder_Alice_Num11_Id2_Clob2_Buy10_Price10_GTB20 = *clobtypes.NewMsgPlaceOrder(
		testapp.MustScaleOrder(
			constants.Order_Alice_Num11_Id2_Clob2_Buy10_Price10_GTB20,
			testapp.DefaultGenesis(),
		),
	)
	...
	PlaceOrder_Alice_Num11_Id2_Clob2_Buy10_Price10_GTB26 = *clobtypes.NewMsgPlaceOrder(
		testapp.MustScaleOrder(
			constants.Order_Alice_Num11_Id2_Clob2_Buy10_Price10_GTB26,
			testapp.DefaultGenesis(),
		),
	)
	...
	PlaceOrder_Alice_Num11_Id3_Clob2_Sell100_Price100000_GTB20 = *clobtypes.NewMsgPlaceOrder(
		testapp.MustScaleOrder(
			constants.Order_Alice_Num11_Id3_Clob2_Sell100_Price100000_GTB20,
			testapp.DefaultGenesis(),
		),
	)
	...
	Order_Alice_Num11_Id4_Clob2_Sell10_Price15_GTB20_PO = *clobtypes.NewMsgPlaceOrder(
		testapp.MustScaleOrder(
			constants.Order_Alice_Num11_Id4_Clob2_Sell10_Price15_GTB20_PO,
			testapp.DefaultGenesis(),
		),
	)
	...
	PlaceOrder_Alice_Num11_Id5_Clob2_Buy10_Price15_GTB23 = *clobtypes.NewMsgPlaceOrder(
		testapp.MustScaleOrder(
			constants.Order_Alice_Num11_Id5_Clob2_Buy10_Price15_GTB23,
			testapp.DefaultGenesis(),
		),
	)
)
...
func TestBTCCollatBatchCancelBatchFunctionality(t *testing.T) {
	tests := map[string]struct {
		firstBlockOrders       []clobtypes.MsgPlaceOrder
		firstBlockBatchCancel  []clobtypes.MsgBatchCancel
		secondBlockOrders      map[clobtypes.MsgPlaceOrder]bool
		...
		"Cancel a batch of orders, one not cancelled": {
			firstBlockOrders: []clobtypes.MsgPlaceOrder{
				PlaceOrder_Alice_Num11_Id1_Clob2_Sell10_Price15_GTB20,
				PlaceOrder_Alice_Num11_Id2_Clob2_Buy10_Price10_GTB20, // not cancelled
				PlaceOrder_Alice_Num11_Id3_Clob2_Sell100_Price100000_GTB20,
				Order_Alice_Num11_Id4_Clob2_Sell10_Price15_GTB20_PO,
				PlaceOrder_Alice_Num11_Id5_Clob2_Buy10_Price15_GTB23,
			},
			firstBlockBatchCancel: []clobtypes.MsgBatchCancel{
				{
					SubaccountId: PlaceOrder_Alice_Num11_Id0_Clob2_Sell10_Price10_GTB20.Order.OrderId.SubaccountId,
					ShortTermCancels: []clobtypes.OrderBatch{
						{
							ClobPairId: 2,
							ClientIds:  []uint32{1, 4, 5},
			...
			expectedOrderIdsInMemclob: map[clobtypes.OrderId]bool{
				constants.Order_Alice_Num11_Id1_Clob2_Sell10_Price15_GTB20.OrderId:    false,
				PlaceOrder_Alice_Num11_Id2_Clob2_Buy10_Price10_GTB20.Order.OrderId:    true,
				constants.Order_Alice_Num11_Id4_Clob2_Sell10_Price15_GTB20_PO.OrderId: false,
				PlaceOrder_Alice_Num11_Id5_Clob2_Buy10_Price15_GTB23.Order.OrderId:    false,
			},
			expectedCancelExpirationsInMemclob: map[clobtypes.OrderId]uint32{
				constants.Order_Alice_Num11_Id1_Clob2_Sell10_Price15_GTB20.OrderId:    25,
				constants.Order_Alice_Num11_Id4_Clob2_Sell10_Price15_GTB20_PO.OrderId: 25,
				PlaceOrder_Alice_Num11_Id5_Clob2_Buy10_Price15_GTB23.Order.OrderId:    25,
			},
		},
		"Cancel a batch of orders, one cancel gtb is for an order with greater gtb": {
			firstBlockOrders: []clobtypes.MsgPlaceOrder{
				PlaceOrder_Alice_Num11_Id1_Clob2_Sell10_Price15_GTB20,
				PlaceOrder_Alice_Num11_Id2_Clob2_Buy10_Price10_GTB26, // gtb 26 is > cancel gtb
				PlaceOrder_Alice_Num11_Id3_Clob2_Sell100_Price100000_GTB20,
				Order_Alice_Num11_Id4_Clob2_Sell10_Price15_GTB20_PO,
				PlaceOrder_Alice_Num11_Id5_Clob2_Buy10_Price15_GTB23,
			},
			...
			expectedOrderIdsInMemclob: map[clobtypes.OrderId]bool{
				constants.Order_Alice_Num11_Id1_Clob2_Sell10_Price15_GTB20.OrderId:    false,
				PlaceOrder_Alice_Num11_Id2_Clob2_Buy10_Price10_GTB26.Order.OrderId:    true,
				constants.Order_Alice_Num11_Id4_Clob2_Sell10_Price15_GTB20_PO.OrderId: false,
				PlaceOrder_Alice_Num11_Id5_Clob2_Buy10_Price15_GTB23.Order.OrderId:    false,
			},
			expectedCancelExpirationsInMemclob: map[clobtypes.OrderId]uint32{
				constants.Order_Alice_Num11_Id1_Clob2_Sell10_Price15_GTB20.OrderId: 25,
				// no cancel for client_id 5 since cancel gtb < existing order gtb
				PlaceOrder_Alice_Num11_Id2_Clob2_Buy10_Price10_GTB26.Order.OrderId:    0,
				constants.Order_Alice_Num11_Id4_Clob2_Sell10_Price15_GTB20_PO.OrderId: 25,
				PlaceOrder_Alice_Num11_Id5_Clob2_Buy10_Price15_GTB23.Order.OrderId:    25,
			},
		},
		"Cancel two batch of orders, overwriting cancel gtb with higher values": {
			firstBlockOrders: []clobtypes.MsgPlaceOrder{
				PlaceOrder_Alice_Num11_Id1_Clob2_Sell10_Price15_GTB20,
				PlaceOrder_Alice_Num11_Id2_Clob2_Buy10_Price10_GTB26,
				PlaceOrder_Alice_Num11_Id3_Clob2_Sell100_Price100000_GTB20,
				Order_Alice_Num11_Id4_Clob2_Sell10_Price15_GTB20_PO,
				PlaceOrder_Alice_Num11_Id5_Clob2_Buy10_Price15_GTB23,
			},
			...
			expectedOrderIdsInMemclob: map[clobtypes.OrderId]bool{
				constants.Order_Alice_Num11_Id1_Clob2_Sell10_Price15_GTB20.OrderId:    false,
				PlaceOrder_Alice_Num11_Id2_Clob2_Buy10_Price10_GTB26.Order.OrderId:    false,
				constants.Order_Alice_Num11_Id4_Clob2_Sell10_Price15_GTB20_PO.OrderId: false,
				PlaceOrder_Alice_Num11_Id5_Clob2_Buy10_Price15_GTB23.Order.OrderId:    false,
			},
			expectedCancelExpirationsInMemclob: map[clobtypes.OrderId]uint32{
				constants.Order_Alice_Num11_Id1_Clob2_Sell10_Price15_GTB20.OrderId:    30,
				PlaceOrder_Alice_Num11_Id2_Clob2_Buy10_Price10_GTB26.Order.OrderId:    30,
				constants.Order_Alice_Num11_Id4_Clob2_Sell10_Price15_GTB20_PO.OrderId: 30,
				PlaceOrder_Alice_Num11_Id5_Clob2_Buy10_Price15_GTB23.Order.OrderId:    30,
			},
		},
		"Batch cancels prevent new orders with lower gtb from being placed": {
			firstBlockOrders: []clobtypes.MsgPlaceOrder{
			...
			secondBlockOrders: map[clobtypes.MsgPlaceOrder]bool{
				PlaceOrder_Alice_Num11_Id1_Clob2_Sell10_Price15_GTB20:      false,
				PlaceOrder_Alice_Num11_Id3_Clob2_Sell100_Price100000_GTB20: false,
			},
			expectedOrderIdsInMemclob: map[clobtypes.OrderId]bool{
				constants.Order_Alice_Num11_Id1_Clob2_Sell10_Price15_GTB20.OrderId: false,
			},
