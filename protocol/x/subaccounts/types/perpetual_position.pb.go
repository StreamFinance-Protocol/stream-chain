...
type PerpetualPosition struct {
	...
	YieldsIndex string `protobuf:"bytes,4,opt,name=yields_index,json=yieldsIndex,proto3" json:"yields_index,omitempty"`
}
...
func (m *PerpetualPosition) GetYieldsIndex() string {
	if m != nil {
...
var fileDescriptor_81b0be873bf88f90 = []byte{
	...
	0x9d, 0x62, 0xe2, 0x12, 0x0c, 0x80, 0x99, 0x16, 0x00, 0x35, 0x4c, 0x48, 0x91, 0x8b, 0x07, 0x61,
	...
	0x16, 0xf3, 0x40, 0x2d, 0xf3, 0x04, 0xd9, 0x05, 0x0a, 0x93, 0xca, 0xcc, 0xd4, 0x9c, 0x94, 0x62,
	0xa8, 0xdd, 0x2c, 0x0a, 0x8c, 0x1a, 0x9c, 0x41, 0xdc, 0x10, 0x31, 0xb0, 0x12, 0xa7, 0xd4, 0x13,
	0x8f, 0xe4, 0x18, 0x2f, 0x3c, 0x92, 0x63, 0x7c, 0xf0, 0x48, 0x8e, 0x71, 0xc2, 0x63, 0x39, 0x86,
	0x0b, 0x8f, 0xe5, 0x18, 0x6e, 0x3c, 0x96, 0x63, 0x88, 0xf2, 0x26, 0xd7, 0x69, 0x15, 0x28, 0xf1,
	0x0e, 0x76, 0x67, 0x12, 0x1b, 0x58, 0xd6, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0x22, 0x5b, 0x21,
	0x87, 0x21, 0x02, 0x00, 0x00,
}
...
func (m *PerpetualPosition) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.YieldsIndex) > 0 {
		...
		i = encodeVarintPerpetualPosition(dAtA, i, uint64(len(m.YieldsIndex)))
		i--
		dAtA[i] = 0x22
	}
	{
